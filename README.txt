...
---| GameServer
   ...
   ---| src
      ...
      ---| de.tuberlin.sese.swtpp.gameserver.model.deathstacks
         Packet f�r die Entity-Klassen des Klassenmodells, d.h. das Datenmodell des konkreten Spiels Death Stacks
...
Wir haben die Web-Funktionalität in dem gegebenen Projekt schon erledigt. Die Interaktion mit den Requests ist also f�r alle Use-Cases bereits erledigt. Die GUI (HTML/Javascript) 
