...
public abstract class Game implements Serializable{
	...
	/** 
	 * Returns a String representation of the game board state, e.g. a String describing
	...
	/**
	 * Returns a String representations of the game status, e.g. values such as finished,
	 * started, etc.
	 * 
	 * @return
	 */
	 ...
	 * ---- the board has to be updated (e.g. figures moved/deleted)
	 * ---- the game status has to be updated (check if game is finished)
	...
	/**
	 * Sets any given board (String representation) to the concrete game (internal representation).
	 * @param state
	 */
